...
class backing_image_keywords:
    ...
    def create_backing_image(self, bi_name, url, expected_checksum="", data_engine="v1", min_copies=1):
        self.backing_image.create(bi_name, url, expected_checksum, data_engine, min_copies)
