...
class longhorn_deploy_keywords:
    ...
    def upgrade_longhorn(self, upgrade_to_transient_version=False, timeout=600, wait_when_fail=True, custom_cmd=""):
        return self.longhorn.upgrade(upgrade_to_transient_version, timeout, wait_when_fail, custom_cmd)
