...
class Base(ABC):
    ...
    @abstractmethod
    def create(self, volume_name, size, numberOfReplicas, frontend, migratable, accessMode, dataEngine, backingImage, Standby, fromBackup, encrypted, rebuildConcurrentSyncLimit, dataSource="", cloneMode=""):
        return NotImplemented
