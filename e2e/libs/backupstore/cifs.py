...
class Cifs(Base):
    ...
    mount_point = "/opt/backupstore"

    def __init__(self):
        super().__init__()

    def get_backup_volume_prefix(self, volume_name):
        return self.mount_point + self.backup_volume_path(volume_name)
    ...
    def create_dummy_backup(self, filename):
        ...
        backupstore_pod_name = get_workload_pod_names("longhorn-test-cifs")[0]
