...
class Nfs(Base):
    ...
    def set_backupstore(self, client):
        ...
        for backupstore in backupstores:
            if self.is_backupTarget_nfs(backupstore):
                self.set_backupstore_url(client, backupstore)
                self.set_backupstore_credential_secret(client, "")
                self.set_backupstore_poll_interval(client, poll_interval)
                self.mount_nfs_backupstore(client)
                break
