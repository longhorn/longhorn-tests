...
Test Encrypted RWX Volume Online Expansion
    ...
    And Assert persistentvolumeclaim 0 requested size remains 100MiB for at least 5 seconds
    And Assert volume size of deployment 0 remains 100MiB for at least 5 seconds
    And Check deployment 0 pods did not restart
    And Assert encrypted disk size in sharemanager pod for deployment 0 is 100MiB
