...
Test Data Engine Cpu Mask Setting
    ...
    # Below values not verified in v2 instance manager pods 
    # Because v2 IM may in error state due to CPU mask exceeding available CPUs
    Given Verify data-engine-cpu-mask 0xff normalizes to {"v2":"0xff"}
