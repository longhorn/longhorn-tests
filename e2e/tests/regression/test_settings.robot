...
Test Setting Update With Valid Value
    ...
    snapshot-data-integrity-immediate-check-after-snapshot-creation    {"v1":"true"}    {"v1":"true"}
...
Test Setting Update With Invalid Value
    ...
    snapshot-data-integrity-immediate-check-after-snapshot-creation    {"v1":"true","v2":"true"}
