...
Test Volume Snapshot Checksum When Healthy Replicas More Then 1
    ...
    ...    2. Wait for the volume to be healthy
    ...    3. Create a snapshot
    ...    4. Verify the snapshot checksum is calculated within 60 seconds
...
Test Volume Snapshot Checksum Skipped When Less Than 2 Healthy Replicas
    ...
    ...    1. Set node 1 and node 2 unschedulable
    ...    2. Create a volume with 3 replicas and attach it to node 0
    ...    3. Wait for the volume to degrade and only 1 healthy replica remains
    ...    4. Create a snapshot
    ...    5. Verify the snapshot checksum is skipped for 60 seconds
