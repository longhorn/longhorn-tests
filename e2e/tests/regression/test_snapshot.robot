...
Test Concurrent Job Limit For Snapshot Purge
    ...
    ...    7. Remove snapshot 2. It will trigger snapshot purge
    ...    8. During the snapshot deletion, try to execute snapshot purge manually
    ...    curl -X POST \
    ...
    # snapshot purge will be triggered automatically
