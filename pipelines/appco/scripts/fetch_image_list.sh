...
get_test_images(){
  ...
  # Replace dp.apps.rancher.io to APPCO_LONGHORN_COMPOMENT_REGISTRY
  if [[ -n "$APPCO_LONGHORN_COMPOMENT_REGISTRY" && "${LONGHORN_CHART_URI}" != "longhorn/longhorn" ]]; then
    CUSTOM_LONGHORN_ENGINE_IMAGE="${CUSTOM_LONGHORN_ENGINE_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
    CUSTOM_LONGHORN_INSTANCE_MANAGER_IMAGE="${CUSTOM_LONGHORN_INSTANCE_MANAGER_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
    CUSTOM_LONGHORN_MANAGER_IMAGE="${CUSTOM_LONGHORN_MANAGER_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
    CUSTOM_LONGHORN_SHARE_MANAGER_IMAGE="${CUSTOM_LONGHORN_SHARE_MANAGER_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
    CUSTOM_LONGHORN_BACKING_IMAGE_MANAGER_IMAGE="${CUSTOM_LONGHORN_BACKING_IMAGE_MANAGER_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
    CUSTOM_LONGHORN_UI_IMAGE="${CUSTOM_LONGHORN_UI_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
    CUSTOM_LONGHORN_SUPPORT_BUNDLE_IMAGE="${CUSTOM_LONGHORN_SUPPORT_BUNDLE_IMAGE/dp.apps.rancher.io/${APPCO_LONGHORN_COMPOMENT_REGISTRY}}"
  fi
}
