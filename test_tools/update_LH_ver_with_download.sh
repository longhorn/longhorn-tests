...
if [ "$#" -ne 3 ]; then
    ...
    echo "  <new_version>       The new version of Longhorn images to use (e.g., v1.8.2-dev-20250323, master-head)."
    ...
    echo "    $0 v1.6.4 v1.6.5-dev-202500323 v1.6.x"
    echo ""
    ...
    echo "    $0 v1.8.1 v1.8.2-dev-20250323 v1.8.x"
    echo ""
    echo "    # For downloading longhorn.yaml from the master branch"
    echo "    $0 master-head v1.9.0-dev-20250323 master"
    echo ""
    exit 1
fi
