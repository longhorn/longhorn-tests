...
from common import cleanup_selected_disks_on_node, core_api, client, csi_pv, pvc, pod_make  # NOQA
...
def test_node_disk_update(client):  # NOQA
    ...
    # cleanup disks
    cleanup_selected_disks_on_node(client, lht_hostId, 'vol-disk-1', 'vol-disk-2')
