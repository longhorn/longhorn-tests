...
def test_replica_should_not_be_created_when_no_suitable_node_found(client, volume_name, settings_reset): # NOQA
    ...
    7. Volume should show failed to schedule.
    8. Decrease the volume replica number to 3.
    9. Volume should be healthy.
    10. Check the data in the volume and make sure it's same as the checksum.
    """
    replica_node_soft_anti_affinity_setting = \
        client.by_id_setting(SETTING_REPLICA_NODE_SOFT_ANTI_AFFINITY)
    try:
