...
from common import backupstore_create_file
from common import backupstore_delete_file
from common import minio_get_volume_backup_prefix
...
def test_backup_volume_list(client, core_api, set_backupstore_s3):  # NOQA
    ...
    prefix = minio_get_volume_backup_prefix(volume1_name) + "/backups"
    backupstore_create_file(client,
                            core_api,
                            prefix,
                            "backup_1234@failure.cfg")
    ...
    bv1 = client.by_id_backupVolume(volume1_name)
    client.delete(bv1)
    wait_for_backup_volume_delete(client, volume1_name)

    bv2 = client.by_id_backupVolume(volume2_name)
    client.delete(bv2)
    wait_for_backup_volume_delete(client, volume2_name)
...
def test_dr_volume_with_last_backup_deletion(
    ...
    8. Wait for the DR volume incremental restore complete.
    9. Delete the 2nd backup.
    10. Verify the `lastBackup == ""` for both volumes.
